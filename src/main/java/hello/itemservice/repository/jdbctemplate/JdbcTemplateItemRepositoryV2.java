...
//    private final JdbcTemplate template;
    ...
    public Item save(Item item) {
        ...
        //파라미터로 넘어온 item객체를 가지고 Item 클래스의 필드들과 이름이 같은 파라미터를 만든다(데이터도 같이 갖고있음).
    ...
    public void update(Long itemId, ItemUpdateDto updateParam) {
        ...
        //SqlParameterSource 은 인터페이스 인데, MapSqlParameterSource 이 구현체다
    ...
    private RowMapper<Item> itemRowMapper() {
        ...
        //그러면 resultSet 가지고  Item클래스의 각 필드 이름으로 해서 데이터를 set하고 만들어서 리턴.
